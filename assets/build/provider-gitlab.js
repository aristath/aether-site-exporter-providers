...
;// ./assets/src/providers/gitlab/Settings.js
/**
...
function GitLabSettings({
  ...
  return /*#__PURE__*/(0,external_ReactJSXRuntime_namespaceObject.jsxs)("form", {
    ...
    children: [error && /*#__PURE__*/(0,external_ReactJSXRuntime_namespaceObject.jsx)("div", {
      ...
      help: (0,external_wp_i18n_namespaceObject.__)('GitLab namespace (username or group) for repository URL', 'aether'),
      ...
      help: (0,external_wp_i18n_namespaceObject.__)('Project path for repository URL', 'aether'),
...
;// ./assets/src/providers/gitlab/index.js
/**
...
(0,external_wp_hooks_namespaceObject.addAction)('aether.provider.sdk.ready', 'gitlab/sdk-ready', SDK => {
  registerProvider(SDK);
});

// Also hook into the provider registration action (fallback)
(0,external_wp_hooks_namespaceObject.addAction)('aether.providers.register', 'gitlab/register', registry => {
  registry.register(GitLabProvider.ID, GitLabProvider);
  // eslint-disable-next-line no-console
...
(0,external_wp_hooks_namespaceObject.addAction)('aether.admin.provider.settings', 'gitlab/settings', (providerId, container) => {
  if (providerId === 'gitlab' && container) {
    (0,external_wp_element_namespaceObject.render)(/*#__PURE__*/(0,external_ReactJSXRuntime_namespaceObject.jsx)(GitLabSettings, {
      providerId: providerId
    }), container);
  }
});
