...
// NAMESPACE OBJECT: ./assets/src/constants/timing.js
var timing_namespaceObject = {};
__webpack_require__.r(timing_namespaceObject);
__webpack_require__.d(timing_namespaceObject, {
  kd: () => (MAX_RETRIES),
  Eu: () => (RETRY_INITIAL_DELAY),
  kB: () => (RETRY_MAX_DELAY)
});
...
;// ./assets/src/providers/cloudflare-r2/Settings.js
/**
...
function CloudflareR2Settings({
  ...
  return /*#__PURE__*/(0,external_ReactJSXRuntime_namespaceObject.jsxs)("form", {
    ...
    children: [error && /*#__PURE__*/(0,external_ReactJSXRuntime_namespaceObject.jsx)("div", {
      ...
      label: (0,external_wp_i18n_namespaceObject.__)('Cloudflare Account ID', 'aether'),
      help: (0,external_wp_i18n_namespaceObject.__)('Your Cloudflare account ID (found in R2 dashboard)', 'aether'),
      value: settings.cloudflare_account_id || '',
      onChange: value => handleChange('cloudflare_account_id', value),
      required: true,
      pattern: "^[a-f0-9]{32}$",
      __next40pxDefaultSize: true,
      __nextHasNoMarginBottom: true
    }), /*#__PURE__*/(0,external_ReactJSXRuntime_namespaceObject.jsx)(external_wp_components_namespaceObject.TextControl, {
      label: (0,external_wp_i18n_namespaceObject.__)('Bucket Name', 'aether'),
      help: (0,external_wp_i18n_namespaceObject.__)('R2 bucket name for file storage', 'aether'),
      ...
      label: (0,external_wp_i18n_namespaceObject.__)('Access Key ID', 'aether'),
      help: (0,external_wp_i18n_namespaceObject.__)('R2 API access key ID', 'aether'),
      ...
      label: (0,external_wp_i18n_namespaceObject.__)('Secret Access Key', 'aether'),
      help: (0,external_wp_i18n_namespaceObject.__)('R2 API secret access key (encrypted)', 'aether'),
      value: settings.secret_access_key || '',
      onChange: value => handleChange('secret_access_key', value),
      placeholder: (0,external_wp_i18n_namespaceObject.__)('Enter secret access key', 'aether')
    }), /*#__PURE__*/(0,external_ReactJSXRuntime_namespaceObject.jsx)(external_wp_components_namespaceObject.TextControl, {
      label: (0,external_wp_i18n_namespaceObject.__)('Public URL (Optional)', 'aether'),
      help: (0,external_wp_i18n_namespaceObject.__)("Your R2 bucket's public URL. Leave empty if bucket is private.", 'aether'),
      ...
      label: (0,external_wp_i18n_namespaceObject.__)('Region (Optional)', 'aether'),
      help: (0,external_wp_i18n_namespaceObject.__)('R2 region hint for optimal performance', 'aether'),
      ...
      label: (0,external_wp_i18n_namespaceObject.__)('Worker Endpoint URL', 'aether'),
      help: (0,external_wp_i18n_namespaceObject.__)('Deployed Cloudflare Worker endpoint for upload proxy (auto-populated after deployment)', 'aether'),
      value: settings.worker_endpoint || '',
      onChange: value => handleChange('worker_endpoint', value),
      type: "url",
      __next40pxDefaultSize: true,
      __nextHasNoMarginBottom: true
    }), /*#__PURE__*/(0,external_ReactJSXRuntime_namespaceObject.jsx)(external_wp_components_namespaceObject.TextControl, {
      label: (0,external_wp_i18n_namespaceObject.__)('Custom Domain (Optional)', 'aether'),
      help: (0,external_wp_i18n_namespaceObject.__)('Custom domain for R2 bucket access (e.g., https://cdn.example.com)', 'aether'),
      ...
      label: (0,external_wp_i18n_namespaceObject.__)('Enable Public Access', 'aether'),
      help: (0,external_wp_i18n_namespaceObject.__)('Allow public read access to bucket contents', 'aether'),
...
async function uploadSingleWithProgress(workerEndpoint, key, file, options = {}) {
  ...
  return new Promise((resolve, reject) => {
    ...
    xhr.timeout = timing_namespaceObject.TIMEOUT_VERY_LONG;
    ...
    xhr.addEventListener('timeout', () => {
      reject(new Error(`Upload timed out after ${timing_namespaceObject.TIMEOUT_VERY_LONG}ms`));
    });
...
function waitForSDK() {
  return new Promise((resolve, reject) => {
    ...
    if (window.AetherProviderSDK && window.AetherProviderSDK.AbstractProvider) {
    ...
    const interval = setInterval(() => {
      ...
      if (window.AetherProviderSDK && window.AetherProviderSDK.AbstractProvider) {
        ...
        clearInterval(interval);
        reject(new Error('AetherProviderSDK.AbstractProvider is not available after waiting. ' + 'Make sure the parent plugin (aether-site-exporter) is active and the SDK is loaded.'));
      }
    }, 100);
  });
}
 ...
 */
class AbstractAWSProvider extends getAbstractProvider() {
  /**
  ...
  getProviderSpecificConfigFields() {
    ...
    return builder.buildAll([builder.text('access_key_id').label((0,external_wp_i18n_namespaceObject.__)('Access Key ID', 'aether')).description((0,external_wp_i18n_namespaceObject.__)('S3-compatible API access key ID', 'aether')).required().min(16).max(128), builder.password('secret_access_key').label((0,external_wp_i18n_namespaceObject.__)('Secret Access Key', 'aether')).description((0,external_wp_i18n_namespaceObject.__)('S3-compatible API secret access key (encrypted)', 'aether')).required().sensitive().min(32).max(128), builder.text('bucket_name').label((0,external_wp_i18n_namespaceObject.__)('Bucket Name', 'aether')).description((0,external_wp_i18n_namespaceObject.__)('Bucket name for file storage', 'aether')).required().pattern('^[a-z0-9][a-z0-9-]{1,61}[a-z0-9]$', (0,external_wp_i18n_namespaceObject.__)('Bucket name must be 3-63 characters, lowercase, start/end with alphanumeric', 'aether')).min(3).max(63), builder.text('region').label((0,external_wp_i18n_namespaceObject.__)('Region (Optional)', 'aether')).description((0,external_wp_i18n_namespaceObject.__)('Storage region (e.g., us-east-1, auto)', 'aether')), builder.url('endpoint').label((0,external_wp_i18n_namespaceObject.__)('Endpoint URL (Optional)', 'aether')).description((0,external_wp_i18n_namespaceObject.__)('Custom endpoint URL for S3-compatible storage', 'aether'))]);
  }
...
// Import from parent plugin's SDK (exposed as window.AetherProviderSDK)
// Access SDK lazily to avoid issues if SDK hasn't loaded yet
function CloudflareR2Provider_getSDK() {
  if (typeof window === 'undefined' || !window.AetherProviderSDK) {
    return null;
  }
  return window.AetherProviderSDK;
}
function CloudflareR2Provider_getConfigFieldBuilder() {
  const SDK = CloudflareR2Provider_getSDK();
  return SDK?.ConfigFieldBuilder || null;
}
function CloudflareR2Provider_getDeploymentTypes() {
  const SDK = CloudflareR2Provider_getSDK();
  return SDK?.DEPLOYMENT_TYPES || {};
}
...
class CloudflareR2Provider extends AbstractAWSProvider {
   ...
   */
  getSupportedDeploymentTypes() {
    const types = CloudflareR2Provider_getDeploymentTypes();
    return [types.STATIC_SITE, types.BLUEPRINT_BUNDLE];
  }
  ...
  getProviderSpecificConfigFields() {
    ...
    const builder = CloudflareR2Provider_getConfigFieldBuilder();
    if (!builder) {
      throw new Error('ConfigFieldBuilder is not available. Make sure AetherProviderSDK is loaded.');
    }
    const r2Fields = builder.buildAll([builder.text('cloudflare_account_id').label((0,external_wp_i18n_namespaceObject.__)('Cloudflare Account ID', 'aether')).description((0,external_wp_i18n_namespaceObject.__)('Your Cloudflare account ID (found in R2 dashboard)', 'aether')).required().pattern('^[a-f0-9]{32}$', (0,external_wp_i18n_namespaceObject.__)('Account ID must be a 32-character hexadecimal string', 'aether')).sensitive(), builder.url('worker_endpoint').label((0,external_wp_i18n_namespaceObject.__)('Worker Endpoint URL', 'aether')).description((0,external_wp_i18n_namespaceObject.__)('Deployed Cloudflare Worker endpoint for upload proxy (auto-populated after deployment)', 'aether')), builder.url('custom_domain').label((0,external_wp_i18n_namespaceObject.__)('Custom Domain (Optional)', 'aether')).description((0,external_wp_i18n_namespaceObject.__)('Custom domain for R2 bucket access (e.g., https://cdn.example.com)', 'aether')), builder.checkbox('public_access').label((0,external_wp_i18n_namespaceObject.__)('Enable Public Access', 'aether')).description((0,external_wp_i18n_namespaceObject.__)('Allow public read access to bucket contents', 'aether')).default(false)]);
  ...
  async getEdgeService() {
    ...
    this.edgeService = new EdgeService(config.cloudflare_account_id, config.access_key_id,
    // API token
    config);
    return this.edgeService;
  }
...
(0,external_wp_hooks_namespaceObject.addAction)('aether.provider.sdk.ready', 'cloudflare-r2/sdk-ready', SDK => {
  // eslint-disable-next-line no-console
...
(0,external_wp_hooks_namespaceObject.addAction)('aether.providers.register', 'cloudflare-r2/register', registry => {
  registry.register(CloudflareR2Provider.ID, CloudflareR2Provider);
  // eslint-disable-next-line no-console
...
(0,external_wp_hooks_namespaceObject.addAction)('aether.admin.provider.settings', 'cloudflare-r2/settings', (providerId, container) => {
  if (providerId === 'cloudflare-r2' && container) {
    (0,external_wp_element_namespaceObject.render)(/*#__PURE__*/(0,external_ReactJSXRuntime_namespaceObject.jsx)(CloudflareR2Settings, {
      providerId: providerId
    }), container);
  }
});
