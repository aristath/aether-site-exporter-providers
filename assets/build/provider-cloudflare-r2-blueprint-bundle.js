...
class CloudflareR2BlueprintBundleProvider {
   ...
   * @type {string}
   */
  static NAME = (0,external_wp_i18n_namespaceObject.__)('Cloudflare R2', 'aether-site-exporter-r2');
   ...
   * @type {string}
   */
  static DESCRIPTION = (0,external_wp_i18n_namespaceObject.__)('Cloudflare R2 object storage for WordPress Playground blueprint bundles with zero egress fees.', 'aether-site-exporter-r2');
  ...
  static CONFIG_FIELDS = [{
    id: 'account_id',
    label: (0,external_wp_i18n_namespaceObject.__)('Cloudflare Account ID', 'aether-site-exporter-r2'),
    type: 'text',
    required: true,
    sensitive: true,
    validation: {
      pattern: '^[a-f0-9]{32}$',
      message: (0,external_wp_i18n_namespaceObject.__)('Account ID must be a 32-character hexadecimal string', 'aether-site-exporter-r2')
    }
  }, {
    id: 'api_token',
    label: (0,external_wp_i18n_namespaceObject.__)('Cloudflare API Token', 'aether-site-exporter-r2'),
    type: 'text',
    required: true,
    sensitive: true,
    validation: {
      minLength: 20,
      message: (0,external_wp_i18n_namespaceObject.__)('API Token must be at least 20 characters', 'aether-site-exporter-r2')
    }
  }, {
    id: 'bucket_name',
    label: (0,external_wp_i18n_namespaceObject.__)('Bucket Name', 'aether-site-exporter-r2'),
    type: 'text',
    required: true,
    sensitive: false,
    validation: {
      ...
      minLength: 3,
      maxLength: 63,
      message: (0,external_wp_i18n_namespaceObject.__)('Bucket name must be 3-63 characters, start and end with alphanumeric, and contain only lowercase letters, numbers, and hyphens', 'aether-site-exporter-r2')
    }
  }, {
    id: 'path',
    label: (0,external_wp_i18n_namespaceObject.__)('Path Prefix', 'aether-site-exporter-r2'),
    type: 'text',
    required: false,
    sensitive: false,
    placeholder: 'my-site/',
    help: (0,external_wp_i18n_namespaceObject.__)('Optional path prefix for all uploaded files (e.g., "my-site/" will upload files as "my-site/bundle.zip")', 'aether-site-exporter-r2'),
    validation: {
      pattern: '^[a-zA-Z0-9._/-]*$',
      message: (0,external_wp_i18n_namespaceObject.__)('Path can only contain letters, numbers, dots, underscores, hyphens, and forward slashes', 'aether-site-exporter-r2')
    }
  }, {
    id: 'worker_endpoint',
    label: (0,external_wp_i18n_namespaceObject.__)('Worker Endpoint URL', 'aether-site-exporter-r2'),
    type: 'url',
    required: false,
    sensitive: false,
    help: (0,external_wp_i18n_namespaceObject.__)('URL of the deployed Cloudflare Worker. Use the Deploy Worker button below to create one.', 'aether-site-exporter-r2')
  }, {
    id: 'access_key_id',
    label: (0,external_wp_i18n_namespaceObject.__)('R2 Access Key ID', 'aether-site-exporter-r2'),
    type: 'text',
    required: false,
    sensitive: true,
    help: (0,external_wp_i18n_namespaceObject.__)('Only required for S3-compatible API access, not for Worker-based uploads.', 'aether-site-exporter-r2'),
    validation: {
      minLength: 16,
      maxLength: 128,
      message: (0,external_wp_i18n_namespaceObject.__)('Access Key ID must be between 16 and 128 characters', 'aether-site-exporter-r2')
    }
  }, {
    id: 'secret_access_key',
    label: (0,external_wp_i18n_namespaceObject.__)('R2 Secret Access Key', 'aether-site-exporter-r2'),
    type: 'text',
    required: false,
    sensitive: true,
    help: (0,external_wp_i18n_namespaceObject.__)('Only required for S3-compatible API access, not for Worker-based uploads.', 'aether-site-exporter-r2'),
    validation: {
      minLength: 32,
      maxLength: 128,
      message: (0,external_wp_i18n_namespaceObject.__)('Secret Access Key must be between 32 and 128 characters', 'aether-site-exporter-r2')
    }
  }, {
    id: 'bundle_path',
    label: (0,external_wp_i18n_namespaceObject.__)('Bundle Path', 'aether-site-exporter-r2'),
    type: 'text',
    required: false,
    sensitive: false,
    placeholder: 'blueprint-bundle/bundle.zip',
    help: (0,external_wp_i18n_namespaceObject.__)('Path within the bucket for the blueprint bundle ZIP file', 'aether-site-exporter-r2')
  }, {
    id: 'public_url',
    label: (0,external_wp_i18n_namespaceObject.__)('Custom Domain (Optional)', 'aether-site-exporter-r2'),
    type: 'url',
    required: false,
    sensitive: false,
    isAdvanced: true
...
const REQUIRED_PERMISSIONS = {
  title: (0,external_wp_i18n_namespaceObject.__)('Required API Token Permissions', 'aether-site-exporter-r2'),
  sections: [{
    title: (0,external_wp_i18n_namespaceObject.__)('R2 Storage', 'aether-site-exporter-r2'),
    items: [{
      permission: 'R2: Edit',
      description: (0,external_wp_i18n_namespaceObject.__)('Read and write files to R2 bucket', 'aether-site-exporter-r2')
    }]
  }, {
    title: (0,external_wp_i18n_namespaceObject.__)('Workers (for deployment)', 'aether-site-exporter-r2'),
    items: [{
      permission: 'Workers Scripts: Edit',
      description: (0,external_wp_i18n_namespaceObject.__)('Deploy and update Workers', 'aether-site-exporter-r2')
    }, {
      permission: 'Workers Routes: Edit',
      description: (0,external_wp_i18n_namespaceObject.__)('Attach custom domains to Workers', 'aether-site-exporter-r2')
    }]
  }, {
    title: (0,external_wp_i18n_namespaceObject.__)('DNS (for custom domains)', 'aether-site-exporter-r2'),
    items: [{
      permission: 'Zone: Read',
      description: (0,external_wp_i18n_namespaceObject.__)('Look up zone IDs for custom domains', 'aether-site-exporter-r2')
    }]
  }],
...
const MANUAL_WORKER_DEPLOYMENT = {
  title: (0,external_wp_i18n_namespaceObject.__)('Manual Worker Deployment', 'aether-site-exporter-r2'),
  steps: [(0,external_wp_i18n_namespaceObject.__)('Go to Cloudflare Dashboard > Workers & Pages', 'aether-site-exporter-r2'), (0,external_wp_i18n_namespaceObject.__)('Click "Create" and select "Create Worker"', 'aether-site-exporter-r2'), (0,external_wp_i18n_namespaceObject.__)('Name your worker (e.g., "my-r2-static-site")', 'aether-site-exporter-r2'), (0,external_wp_i18n_namespaceObject.__)('Go to Settings > Variables > R2 Bucket Bindings', 'aether-site-exporter-r2'), (0,external_wp_i18n_namespaceObject.__)('Add binding: Variable name "R2_BUCKET", select your bucket', 'aether-site-exporter-r2'), (0,external_wp_i18n_namespaceObject.__)('Deploy the worker and copy the URL', 'aether-site-exporter-r2')],
...
const MANUAL_DOMAIN_ATTACHMENT = {
  title: (0,external_wp_i18n_namespaceObject.__)('Manual Domain Attachment', 'aether-site-exporter-r2'),
  steps: [(0,external_wp_i18n_namespaceObject.__)('Go to Cloudflare Dashboard > Workers & Pages', 'aether-site-exporter-r2'), (0,external_wp_i18n_namespaceObject.__)('Select your worker', 'aether-site-exporter-r2'), (0,external_wp_i18n_namespaceObject.__)('Go to Settings > Triggers > Custom Domains', 'aether-site-exporter-r2'), (0,external_wp_i18n_namespaceObject.__)('Click "Add Custom Domain"', 'aether-site-exporter-r2'), (0,external_wp_i18n_namespaceObject.__)('Enter your domain and confirm', 'aether-site-exporter-r2')],
  note: (0,external_wp_i18n_namespaceObject.__)('Ensure the domain is on the same Cloudflare account and proxied through Cloudflare (orange cloud).', 'aether-site-exporter-r2'),
  ...
  return /*#__PURE__*/(0,external_ReactJSXRuntime_namespaceObject.jsxs)("div", {
    ...
    children: [/*#__PURE__*/(0,external_ReactJSXRuntime_namespaceObject.jsxs)("div", {
      ...
      children: [/*#__PURE__*/(0,external_ReactJSXRuntime_namespaceObject.jsx)("strong", {
        children: (0,external_wp_i18n_namespaceObject.__)('Before you begin', 'aether-site-exporter-r2')
      }), /*#__PURE__*/(0,external_ReactJSXRuntime_namespaceObject.jsx)(external_wp_components_namespaceObject.Button, {
        variant: "link",
        onClick: () => setIsExpanded(!isExpanded),
        style: toggleButtonStyle,
        "aria-expanded": isExpanded,
        children: isExpanded ? (0,external_wp_i18n_namespaceObject.__)('Hide details', 'aether-site-exporter-r2') : (0,external_wp_i18n_namespaceObject.__)('Show details', 'aether-site-exporter-r2')
      })]
      ...
      children: [(0,external_wp_i18n_namespaceObject.__)('You need a Cloudflare API token with R2, Workers, and Zone permissions.', 'aether-site-exporter-r2'), ' ', /*#__PURE__*/(0,external_ReactJSXRuntime_namespaceObject.jsx)(external_wp_components_namespaceObject.ExternalLink, {
        href: REQUIRED_PERMISSIONS.createTokenUrl,
        children: (0,external_wp_i18n_namespaceObject.__)('Create API Token', 'aether-site-exporter-r2')
      })]
      ...
      children: [/*#__PURE__*/(0,external_ReactJSXRuntime_namespaceObject.jsx)("p", {
        ...
        children: (0,external_wp_i18n_namespaceObject.__)('Create a Cloudflare API token with these permissions:', 'aether-site-exporter-r2')
        ...
        children: /*#__PURE__*/(0,external_ReactJSXRuntime_namespaceObject.jsx)(external_wp_components_namespaceObject.ExternalLink, {
          href: REQUIRED_PERMISSIONS.createTokenUrl,
          children: (0,external_wp_i18n_namespaceObject.__)('Create API Token in Cloudflare Dashboard', 'aether-site-exporter-r2')
        })
      })]
    })]
  });
...
function APITokenHelpSection() {
  ...
  return /*#__PURE__*/(0,external_ReactJSXRuntime_namespaceObject.jsxs)("div", {
    ...
    children: [/*#__PURE__*/(0,external_ReactJSXRuntime_namespaceObject.jsx)(external_wp_components_namespaceObject.Button, {
      ...
      style: toggleButtonStyle,
      "aria-expanded": isExpanded,
      children: isExpanded ? (0,external_wp_i18n_namespaceObject.__)('Hide token creation steps', 'aether-site-exporter-r2') : (0,external_wp_i18n_namespaceObject.__)('How to create an API token', 'aether-site-exporter-r2')
    }), isExpanded && /*#__PURE__*/(0,external_ReactJSXRuntime_namespaceObject.jsxs)("div", {
      style: contentStyle,
      children: [/*#__PURE__*/(0,external_ReactJSXRuntime_namespaceObject.jsxs)("ol", {
        ...
        children: [/*#__PURE__*/(0,external_ReactJSXRuntime_namespaceObject.jsx)("li", {
          style: listItemStyle,
          children: (0,external_wp_i18n_namespaceObject.__)('Go to Cloudflare Dashboard > My Profile > API Tokens', 'aether-site-exporter-r2')
        }), /*#__PURE__*/(0,external_ReactJSXRuntime_namespaceObject.jsx)("li", {
          style: listItemStyle,
          children: (0,external_wp_i18n_namespaceObject.__)('Click "Create Token"', 'aether-site-exporter-r2')
        }), /*#__PURE__*/(0,external_ReactJSXRuntime_namespaceObject.jsx)("li", {
          style: listItemStyle,
          children: (0,external_wp_i18n_namespaceObject.__)('Select "Create Custom Token"', 'aether-site-exporter-r2')
        }), /*#__PURE__*/(0,external_ReactJSXRuntime_namespaceObject.jsxs)("li", {
          style: listItemStyle,
          children: [(0,external_wp_i18n_namespaceObject.__)('Add these permissions:', 'aether-site-exporter-r2'), /*#__PURE__*/(0,external_ReactJSXRuntime_namespaceObject.jsxs)("ul", {
          ...
          style: listItemStyle,
          children: (0,external_wp_i18n_namespaceObject.__)('Create the token and copy it here', 'aether-site-exporter-r2')
        })]
        ...
        children: (0,external_wp_i18n_namespaceObject.__)('View Cloudflare Documentation', 'aether-site-exporter-r2')
      })]
    })]
  });
}
  ...
  if (errorType === 'worker_deployment') {
    return /*#__PURE__*/(0,external_ReactJSXRuntime_namespaceObject.jsxs)("div", {
      ...
      children: [/*#__PURE__*/(0,external_ReactJSXRuntime_namespaceObject.jsx)(external_wp_components_namespaceObject.Button, {
        ...
        style: toggleButtonStyle,
        "aria-expanded": isExpanded,
        children: isExpanded ? (0,external_wp_i18n_namespaceObject.__)('Hide manual instructions', 'aether-site-exporter-r2') : (0,external_wp_i18n_namespaceObject.__)('How to deploy manually', 'aether-site-exporter-r2')
      }), isExpanded && /*#__PURE__*/(0,external_ReactJSXRuntime_namespaceObject.jsxs)("div", {
        style: contentStyle,
        children: [/*#__PURE__*/(0,external_ReactJSXRuntime_namespaceObject.jsx)("p", {
          style: {
          ...
          children: (0,external_wp_i18n_namespaceObject.__)('If automatic deployment fails, you can deploy the worker manually:', 'aether-site-exporter-r2')
          ...
          children: (0,external_wp_i18n_namespaceObject.__)('Open Workers & Pages', 'aether-site-exporter-r2')
        }), ' | ', /*#__PURE__*/(0,external_ReactJSXRuntime_namespaceObject.jsx)(external_wp_components_namespaceObject.ExternalLink, {
          href: CLOUDFLARE_DOCS.workersBindings,
          children: (0,external_wp_i18n_namespaceObject.__)('View Bindings Documentation', 'aether-site-exporter-r2')
        })]
      })]
    });
  }
  if (errorType === 'domain_attachment') {
    return /*#__PURE__*/(0,external_ReactJSXRuntime_namespaceObject.jsxs)("div", {
      ...
      children: [/*#__PURE__*/(0,external_ReactJSXRuntime_namespaceObject.jsx)(external_wp_components_namespaceObject.Button, {
        ...
        style: toggleButtonStyle,
        "aria-expanded": isExpanded,
        children: isExpanded ? (0,external_wp_i18n_namespaceObject.__)('Hide manual instructions', 'aether-site-exporter-r2') : (0,external_wp_i18n_namespaceObject.__)('How to attach domain manually', 'aether-site-exporter-r2')
      }), isExpanded && /*#__PURE__*/(0,external_ReactJSXRuntime_namespaceObject.jsxs)("div", {
        style: contentStyle,
        children: [/*#__PURE__*/(0,external_ReactJSXRuntime_namespaceObject.jsx)("p", {
          style: {
          ...
          children: (0,external_wp_i18n_namespaceObject.__)('If custom domain attachment fails, configure it manually:', 'aether-site-exporter-r2')
        }), /*#__PURE__*/(0,external_ReactJSXRuntime_namespaceObject.jsx)("ol", {
          style: listStyle,
          ...
          children: (0,external_wp_i18n_namespaceObject.__)('View Custom Domains Documentation', 'aether-site-exporter-r2')
        })]
      })]
    });
  }
...
function ManualWorkerSetupModal({
  ...
  return /*#__PURE__*/(0,external_ReactJSXRuntime_namespaceObject.jsx)(external_wp_components_namespaceObject.Modal, {
    title: (0,external_wp_i18n_namespaceObject.__)('Manual Worker Setup Instructions', 'aether-site-exporter-r2'),
    onRequestClose: onClose,
    style: modalStyle,
    className: "aether-manual-worker-modal",
    children: /*#__PURE__*/(0,external_ReactJSXRuntime_namespaceObject.jsxs)("div", {
      className: "aether-manual-worker-modal__content",
      children: [/*#__PURE__*/(0,external_ReactJSXRuntime_namespaceObject.jsxs)("div", {
        style: sectionStyle,
        children: [/*#__PURE__*/(0,external_ReactJSXRuntime_namespaceObject.jsx)("h3", {
          style: headingStyle,
          children: (0,external_wp_i18n_namespaceObject.__)('Step 1: Create a Worker', 'aether-site-exporter-r2')
          ...
          children: [/*#__PURE__*/(0,external_ReactJSXRuntime_namespaceObject.jsxs)("li", {
            style: listItemStyle,
            children: [(0,external_wp_i18n_namespaceObject.__)('Go to', 'aether-site-exporter-r2'), ' ', /*#__PURE__*/(0,external_ReactJSXRuntime_namespaceObject.jsx)("a", {
            ...
            style: listItemStyle,
            children: (0,external_wp_i18n_namespaceObject.__)('Click "Create" and select "Create Worker"', 'aether-site-exporter-r2')
          }), /*#__PURE__*/(0,external_ReactJSXRuntime_namespaceObject.jsx)("li", {
            style: listItemStyle,
            children: (0,external_wp_i18n_namespaceObject.__)('Name your worker (e.g., "aether-r2-mysite")', 'aether-site-exporter-r2')
          }), /*#__PURE__*/(0,external_ReactJSXRuntime_namespaceObject.jsx)("li", {
            style: listItemStyle,
            children: (0,external_wp_i18n_namespaceObject.__)('Click "Deploy" to create the worker with default code', 'aether-site-exporter-r2')
          })]
        })]
        ...
        children: [/*#__PURE__*/(0,external_ReactJSXRuntime_namespaceObject.jsx)("h3", {
          style: headingStyle,
          children: (0,external_wp_i18n_namespaceObject.__)('Step 2: Add R2 Bucket Binding', 'aether-site-exporter-r2')
        }), /*#__PURE__*/(0,external_ReactJSXRuntime_namespaceObject.jsxs)("ol", {
          style: listStyle,
          children: [/*#__PURE__*/(0,external_ReactJSXRuntime_namespaceObject.jsx)("li", {
            style: listItemStyle,
            children: (0,external_wp_i18n_namespaceObject.__)('In your worker, go to Settings > Variables', 'aether-site-exporter-r2')
          }), /*#__PURE__*/(0,external_ReactJSXRuntime_namespaceObject.jsx)("li", {
            style: listItemStyle,
            children: (0,external_wp_i18n_namespaceObject.__)('Scroll down to "R2 Bucket Bindings"', 'aether-site-exporter-r2')
          }), /*#__PURE__*/(0,external_ReactJSXRuntime_namespaceObject.jsx)("li", {
            style: listItemStyle,
            children: (0,external_wp_i18n_namespaceObject.__)('Click "Add binding"', 'aether-site-exporter-r2')
          }), /*#__PURE__*/(0,external_ReactJSXRuntime_namespaceObject.jsxs)("li", {
            style: listItemStyle,
            children: [/*#__PURE__*/(0,external_ReactJSXRuntime_namespaceObject.jsx)("strong", {
              children: (0,external_wp_i18n_namespaceObject.__)('Variable name:', 'aether-site-exporter-r2')
            }), ' ', /*#__PURE__*/(0,external_ReactJSXRuntime_namespaceObject.jsx)("code", {
              children: "R2_BUCKET"
            }), ' ', (0,external_wp_i18n_namespaceObject.__)('(must be exactly this name)', 'aether-site-exporter-r2')]
          }), /*#__PURE__*/(0,external_ReactJSXRuntime_namespaceObject.jsxs)("li", {
            style: listItemStyle,
            children: [/*#__PURE__*/(0,external_ReactJSXRuntime_namespaceObject.jsx)("strong", {
              children: (0,external_wp_i18n_namespaceObject.__)('R2 bucket:', 'aether-site-exporter-r2')
            }), ' ', bucketName ? /*#__PURE__*/(0,external_ReactJSXRuntime_namespaceObject.jsxs)(external_ReactJSXRuntime_namespaceObject.Fragment, {
              children: [(0,external_wp_i18n_namespaceObject.__)('Select', 'aether-site-exporter-r2'), ' ', /*#__PURE__*/(0,external_ReactJSXRuntime_namespaceObject.jsx)("code", {
                children: bucketName
              })]
            }) : (0,external_wp_i18n_namespaceObject.__)('Select your R2 bucket', 'aether-site-exporter-r2')]
          }), /*#__PURE__*/(0,external_ReactJSXRuntime_namespaceObject.jsx)("li", {
            style: listItemStyle,
            children: (0,external_wp_i18n_namespaceObject.__)('Click "Save" to save the binding', 'aether-site-exporter-r2')
          })]
        })]
      }), /*#__PURE__*/(0,external_ReactJSXRuntime_namespaceObject.jsxs)("div", {
        style: sectionStyle,
        children: [/*#__PURE__*/(0,external_ReactJSXRuntime_namespaceObject.jsx)("h3", {
          style: headingStyle,
          children: (0,external_wp_i18n_namespaceObject.__)('Step 3: Replace Worker Code', 'aether-site-exporter-r2')
        }), /*#__PURE__*/(0,external_ReactJSXRuntime_namespaceObject.jsxs)("ol", {
          style: listStyle,
          children: [/*#__PURE__*/(0,external_ReactJSXRuntime_namespaceObject.jsx)("li", {
            style: listItemStyle,
            children: (0,external_wp_i18n_namespaceObject.__)('Go to your worker\'s "Code" tab', 'aether-site-exporter-r2')
          }), /*#__PURE__*/(0,external_ReactJSXRuntime_namespaceObject.jsx)("li", {
            style: listItemStyle,
            children: (0,external_wp_i18n_namespaceObject.__)('Delete all existing code', 'aether-site-exporter-r2')
          }), /*#__PURE__*/(0,external_ReactJSXRuntime_namespaceObject.jsx)("li", {
            style: listItemStyle,
            children: (0,external_wp_i18n_namespaceObject.__)('Paste the code below:', 'aether-site-exporter-r2')
          })]
        }), /*#__PURE__*/(0,external_ReactJSXRuntime_namespaceObject.jsxs)("div", {
          ...
          children: [isLoading && /*#__PURE__*/(0,external_ReactJSXRuntime_namespaceObject.jsxs)("div", {
            ...
            children: [/*#__PURE__*/(0,external_ReactJSXRuntime_namespaceObject.jsx)(external_wp_components_namespaceObject.Spinner, {}), /*#__PURE__*/(0,external_ReactJSXRuntime_namespaceObject.jsx)("span", {
              children: (0,external_wp_i18n_namespaceObject.__)('Loading worker code...', 'aether-site-exporter-r2')
            })]
            ...
            children: [/*#__PURE__*/(0,external_ReactJSXRuntime_namespaceObject.jsx)("div", {
              ...
              children: /*#__PURE__*/(0,external_ReactJSXRuntime_namespaceObject.jsx)(external_wp_components_namespaceObject.Button, {
                ...
                disabled: copied,
                children: copied ? (0,external_wp_i18n_namespaceObject.__)('Copied!', 'aether-site-exporter-r2') : (0,external_wp_i18n_namespaceObject.__)('Copy Code', 'aether-site-exporter-r2')
              })
        ...
        children: [/*#__PURE__*/(0,external_ReactJSXRuntime_namespaceObject.jsx)("h3", {
          style: headingStyle,
          children: (0,external_wp_i18n_namespaceObject.__)('Step 4: Deploy and Copy URL', 'aether-site-exporter-r2')
        }), /*#__PURE__*/(0,external_ReactJSXRuntime_namespaceObject.jsxs)("ol", {
          style: listStyle,
          children: [/*#__PURE__*/(0,external_ReactJSXRuntime_namespaceObject.jsx)("li", {
            style: listItemStyle,
            children: (0,external_wp_i18n_namespaceObject.__)('Click "Save and Deploy" to deploy your worker', 'aether-site-exporter-r2')
          }), /*#__PURE__*/(0,external_ReactJSXRuntime_namespaceObject.jsx)("li", {
            style: listItemStyle,
            children: (0,external_wp_i18n_namespaceObject.__)('Copy the worker URL (e.g., https://aether-r2-mysite.your-subdomain.workers.dev)', 'aether-site-exporter-r2')
          }), /*#__PURE__*/(0,external_ReactJSXRuntime_namespaceObject.jsx)("li", {
            style: listItemStyle,
            children: (0,external_wp_i18n_namespaceObject.__)('Paste it in the "Worker Endpoint URL" field in this form', 'aether-site-exporter-r2')
          })]
        })]
        ...
        isDismissible: false,
        children: [/*#__PURE__*/(0,external_ReactJSXRuntime_namespaceObject.jsx)("strong", {
          children: (0,external_wp_i18n_namespaceObject.__)('Important:', 'aether-site-exporter-r2')
        }), ' ', (0,external_wp_i18n_namespaceObject.__)('The R2 bucket binding variable name MUST be exactly "R2_BUCKET" (case-sensitive). The worker will not work without this binding.', 'aether-site-exporter-r2')]
      }), /*#__PURE__*/(0,external_ReactJSXRuntime_namespaceObject.jsxs)("div", {
        style: noteStyle,
        children: [/*#__PURE__*/(0,external_ReactJSXRuntime_namespaceObject.jsx)("strong", {
          children: (0,external_wp_i18n_namespaceObject.__)('Need more help?', 'aether-site-exporter-r2')
        }), /*#__PURE__*/(0,external_ReactJSXRuntime_namespaceObject.jsx)("br", {}), /*#__PURE__*/(0,external_ReactJSXRuntime_namespaceObject.jsx)("a", {
          href: CLOUDFLARE_DOCS.workersBindings,
          target: "_blank",
          rel: "noopener noreferrer",
          children: (0,external_wp_i18n_namespaceObject.__)('R2 Bucket Bindings Documentation', 'aether-site-exporter-r2')
        }), ' | ', /*#__PURE__*/(0,external_ReactJSXRuntime_namespaceObject.jsx)("a", {
          href: CLOUDFLARE_DOCS.r2Overview,
          target: "_blank",
          rel: "noopener noreferrer",
          children: (0,external_wp_i18n_namespaceObject.__)('R2 Overview', 'aether-site-exporter-r2')
        })]
        ...
        children: /*#__PURE__*/(0,external_ReactJSXRuntime_namespaceObject.jsx)(external_wp_components_namespaceObject.Button, {
          variant: "primary",
          onClick: onClose,
          children: (0,external_wp_i18n_namespaceObject.__)('Close', 'aether-site-exporter-r2')
        })
      })]
    })
  });
...
function DeployWorkerButton({
  ...
  const handleDeploy = async () => {
    ...
    try {
      ...
      if (!config?.account_id || !config?.api_token || !config?.bucket_name) {
        throw new Error((0,external_wp_i18n_namespaceObject.__)('Cloudflare Account ID, API Token, and Bucket Name are required to deploy the worker', 'aether-site-exporter-r2'));
      }
      ...
      if (!deployResponse.ok) {
        ...
        throw new Error(errorData.message || errorData.error || (0,external_wp_i18n_namespaceObject.__)('Failed to deploy worker', 'aether-site-exporter-r2'));
      }
      const result = await deployResponse.json();
      if (!result.success) {
        throw new Error(result.message || result.error || (0,external_wp_i18n_namespaceObject.__)('Failed to deploy worker', 'aether-site-exporter-r2'));
      }
      ...
      setError(err.message || (0,external_wp_i18n_namespaceObject.__)('Failed to deploy worker', 'aether-site-exporter-r2'));
    } finally {
      setDeploying(false);
    }
  };
  ...
  return /*#__PURE__*/(0,external_ReactJSXRuntime_namespaceObject.jsxs)("div", {
    ...
    children: [/*#__PURE__*/(0,external_ReactJSXRuntime_namespaceObject.jsxs)("div", {
      ...
      children: [/*#__PURE__*/(0,external_ReactJSXRuntime_namespaceObject.jsx)(external_wp_components_namespaceObject.Button, {
        ...
        isBusy: deploying,
        disabled: deploying || !config?.account_id || !config?.api_token || !config?.bucket_name,
        children: deploying ? (0,external_wp_i18n_namespaceObject.__)('Deploying…', 'aether-site-exporter-r2') : (0,external_wp_i18n_namespaceObject.__)('Deploy Worker', 'aether-site-exporter-r2')
      }), /*#__PURE__*/(0,external_ReactJSXRuntime_namespaceObject.jsx)(external_wp_components_namespaceObject.Button, {
        variant: "tertiary",
        onClick: () => setShowManualSetup(true),
        children: (0,external_wp_i18n_namespaceObject.__)('Manual Setup', 'aether-site-exporter-r2')
      })]
      ...
      children: [(0,external_wp_i18n_namespaceObject.__)('Worker deployed successfully!', 'aether-site-exporter-r2'), workerUrl && /*#__PURE__*/(0,external_ReactJSXRuntime_namespaceObject.jsxs)("div", {
        style: {
          marginTop: '0.5rem'
        },
        children: [/*#__PURE__*/(0,external_ReactJSXRuntime_namespaceObject.jsx)("strong", {
          children: (0,external_wp_i18n_namespaceObject.__)('Worker URL:', 'aether-site-exporter-r2')
        }), ' ', /*#__PURE__*/(0,external_ReactJSXRuntime_namespaceObject.jsx)("a", {
          href: workerUrl,
          target: "_blank",
          rel: "noopener noreferrer",
...
function initCloudflareR2ModalHooks(providerIdPrefix) {
  ...
  (0,external_wp_hooks_namespaceObject.addFilter)('aether.admin.provider.modal.header', `aether/${providerIdPrefix}/setup-guide`, (content, context) => {
  ...
  (0,external_wp_hooks_namespaceObject.addFilter)('aether.admin.provider.field.after', `aether/${providerIdPrefix}/api-token-help`, (content, context) => {
  ...
  (0,external_wp_hooks_namespaceObject.addFilter)('aether.admin.provider.field.after', `aether/${providerIdPrefix}/deploy-button`, (content, context) => {
...
(0,external_wp_hooks_namespaceObject.doAction)('aether.providers.register', CloudflareR2BlueprintBundleProvider);
 ...
 */
(0,external_wp_hooks_namespaceObject.addAction)('aether.file.upload', 'aether/cloudflare-r2-blueprint-bundle', fileContext => {
 ...
 */
(0,external_wp_hooks_namespaceObject.addFilter)('aether.provider.test', 'aether/cloudflare-r2-blueprint-bundle', (handler, providerId) => {
 ...
 */
(0,external_wp_hooks_namespaceObject.addFilter)('aether.provider.upload_strategy', 'aether/cloudflare-r2-blueprint-bundle', (strategy, providerId) => {
  if (providerId?.startsWith('cloudflare-r2-blueprint-bundle')) {
    return 'worker';
  }
  return strategy;
