...
class CloudflareR2BlueprintBundleProvider {
   ...
   * @type {string}
   */
  static DESCRIPTION = (0,external_wp_i18n_namespaceObject.__)('Cloudflare R2 object storage for WordPress Playground blueprint bundles with zero egress fees.', 'aether-site-exporter-providers');
  ...
  static CONFIG_FIELDS = [{
    ...
    required: false,
    sensitive: true,
    help: (0,external_wp_i18n_namespaceObject.__)('Only required for S3-compatible API access, not for Worker-based uploads.', 'aether-site-exporter-providers'),
    validation: {
      minLength: 16,
      maxLength: 128,
    ...
    id: 'bundle_path',
    label: (0,external_wp_i18n_namespaceObject.__)('Bundle Path', 'aether-site-exporter-providers'),
    type: 'text',
    required: false,
    sensitive: false,
    placeholder: 'blueprint-bundle/bundle.zip',
    help: (0,external_wp_i18n_namespaceObject.__)('Path within the bucket for the blueprint bundle ZIP file', 'aether-site-exporter-providers')
  }, {
    id: 'custom_domain',
  ...
  const handleDeploy = async () => {
    ...
    try {
      ...
      if (!config?.account_id || !config?.api_token || !config?.bucket_name) {
        throw new Error((0,external_wp_i18n_namespaceObject.__)('Cloudflare Account ID, API Token, and Bucket Name are required to deploy the worker', 'aether-site-exporter-providers'));
      }
...
function initCloudflareR2ModalHooks(providerIdPrefix) {
  ...
  (0,external_wp_hooks_namespaceObject.addFilter)('aether.admin.provider.field.after', `aether/${providerIdPrefix}/deploy-button`, (content, context) => {
    ...
    return /*#__PURE__*/(0,external_ReactJSXRuntime_namespaceObject.jsx)(DeployWorkerButton, {
