...
class CloudflareR2StaticSiteProvider {
   ...
   * @type {string}
   */
  static DESCRIPTION = (0,external_wp_i18n_namespaceObject.__)('Cloudflare R2 object storage for static site exports with zero egress fees.', 'aether-site-exporter-r2');
  ...
  static CONFIG_FIELDS = [{
    ...
    sensitive: false,
    placeholder: 'my-site/',
    help: (0,external_wp_i18n_namespaceObject.__)('Optional path prefix for all uploaded files (e.g., "my-site/" will upload files as "my-site/index.html")', 'aether-site-exporter-r2'),
    validation: {
      pattern: '^[a-zA-Z0-9._/-]*$',
    ...
    required: false,
    sensitive: false,
    help: (0,external_wp_i18n_namespaceObject.__)('The custom domain for your static site (e.g., https://example.com). If provided, the Deploy Worker button will automatically attach it to the worker.', 'aether-site-exporter-r2')
  }, {
    id: 'worker_endpoint',
  ...
  const handleDeploy = async () => {
    ...
    try {
      ...
      if (result.worker_url && config.public_url) {
        try {
          const edgeService = new EdgeService(config.account_id, config.api_token, config, 'cloudflare-r2-static-site');
          ...
          if (zoneResult.success && zoneResult.data?.zoneId) {
            ...
            setDomainError(zoneResult.error || (0,external_wp_i18n_namespaceObject.__)('Could not find zone for domain', 'aether-site-exporter-r2'));
          }
        } catch (domainErr) {
  ...
  return /*#__PURE__*/(0,external_ReactJSXRuntime_namespaceObject.jsxs)("div", {
    ...
    children: [/*#__PURE__*/(0,external_ReactJSXRuntime_namespaceObject.jsxs)("div", {
      ...
      children: [(0,external_wp_i18n_namespaceObject.__)('Worker deployed successfully!', 'aether-site-exporter-r2'), workerUrl && /*#__PURE__*/(0,external_ReactJSXRuntime_namespaceObject.jsxs)("div", {
        ...
        children: [/*#__PURE__*/(0,external_ReactJSXRuntime_namespaceObject.jsx)("strong", {
          children: (0,external_wp_i18n_namespaceObject.__)('Custom domain attached:', 'aether-site-exporter-r2')
        }), ' ', /*#__PURE__*/(0,external_ReactJSXRuntime_namespaceObject.jsx)("a", {
        ...
        children: [/*#__PURE__*/(0,external_ReactJSXRuntime_namespaceObject.jsxs)("div", {
          ...
          children: [/*#__PURE__*/(0,external_ReactJSXRuntime_namespaceObject.jsx)("strong", {
            children: (0,external_wp_i18n_namespaceObject.__)('Custom domain warning:', 'aether-site-exporter-r2')
          }), ' ', domainError]
        }), /*#__PURE__*/(0,external_ReactJSXRuntime_namespaceObject.jsx)(DeploymentErrorHelp, {
...
function createUploadAdapter(workerEndpoint) {
  return {
    ...
    async upload(key, file, options = {}) {
      ...
      return uploadFile(workerEndpoint, key, fileToUpload, options);
    }
  };
}
